...
session_start();
	...
	$get = mysqli_query($db, "SELECT * FROM dash3k");
	
	
	if(isset($_GET['visible_id'])){
	    $id = $_GET['visible_id'];
	    $find = mysqli_query($db, "SELECT * FROM dash3k WHERE id='$id' ");
	...
	if(isset($_POST['update'])){
	    ...
	    mysqli_query($db,"UPDATE dash3k SET visible = '$visible' WHERE id = '$id' ");
	    header("Location: index.php");
	}
