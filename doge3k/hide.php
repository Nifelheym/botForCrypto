...
session_start();
	...
	$get = mysqli_query($db, "SELECT * FROM doge3k");
	
	
	if(isset($_GET['visible_id'])){
	    $id = $_GET['visible_id'];
	    $find = mysqli_query($db, "SELECT * FROM doge3k WHERE id='$id' ");
	...
	if(isset($_POST['update'])){
	    ...
	    mysqli_query($db,"UPDATE doge3k SET visible = '$visible' WHERE id = '$id' ");
	     header("Location: index.php");
	}
